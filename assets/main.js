...
(function () {
  ...
  var FIN = {
    ...
    niquel: { lo: [0.13, 0.13, 0.14], mid: [0.62, 0.65, 0.68], hi: [0.93, 0.95, 0.97], css: ['#3a3d40', '#9ea6ad', '#eef2f6'] },
    cromo:  { lo: [0.07, 0.08, 0.10], mid: [0.68, 0.74, 0.80], hi: [1.00, 1.00, 1.00], css: ['#23272c', '#aeb8c2', '#ffffff'] },
    zinco:  { lo: [0.12, 0.14, 0.16], mid: [0.50, 0.56, 0.61], hi: [0.85, 0.90, 0.93], css: ['#333a40', '#7f8b94', '#d9e2e8'] }
  };
